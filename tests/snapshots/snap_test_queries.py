...
snapshots['test_query_union_sdchild_core 1'] = '''SELECT sdchild.id, sdchild.deleted_at, sdchild.parent_id 
FROM sdchild 
WHERE sdchild.deleted_at IS NULL UNION SELECT sdchild.id, sdchild.deleted_at, sdchild.parent_id 
FROM sdchild 
WHERE sdchild.deleted_at IS NULL'''
