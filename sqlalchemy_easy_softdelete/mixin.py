...
from sqlalchemy_easy_softdelete.hook import EnabledTable, IgnoredTable
...
def generate_soft_delete_mixin_class(
    ...
    activate_soft_delete_hook(
        deleted_field_name, disable_soft_delete_filtering_option_name, ignored_tables, enabled_tables=enabled_tables
    )
